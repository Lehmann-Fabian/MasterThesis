...
public class Warning implements DataEntry {
	...
	public String getCSVData() {
		String values = Arrays.toString(getValues());
		values = values.substring(1, values.length() - 2);
		String result = "\"" + getWarning() + "\"," + getBeginOffset() + ',' + getEndOffset() + ',' + getBeginTimestamp() + ',' + getEndTimestamp() + ",\"" + values + "\"";
		return result;
	}
